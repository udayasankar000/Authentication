...
class Login extends Component {
    ...
    render(){
        ...
        let submitBtn = this.state.loginBtn ? 
            (<input className="loginBtn" type="submit" placeholder="Enter Email Id" onClick={this.login} value="Enter" />) : 
            (<input className="loginBtn" type="submit" placeholder="Enter Password" onClick={this.register} value="Register" />);
